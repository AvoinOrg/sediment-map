...
import { fromUrl, fromUrls, Pool } from 'geotiff/src/geotiff';
...
class MapView extends Component {
  ...
  componentDidMount() {
    ...
    this.map.getView().setCenter([-83.279587, 8.602611]);
  ...
  async addSceneLayer(scene) {
    ...
    source.on('tileloaderror', (a,b,c) =>  console.error('tileloaderror',a,b,c))
